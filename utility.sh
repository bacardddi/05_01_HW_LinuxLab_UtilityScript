...
# cat > reports/utility_report.txt << EOF
# ============================================
#   DEPARTMENT FILE ORGANIZER — FINAL REPORT
# ============================================
# Date/Time Script Ran: $(date)
# Working Directory:    $(pwd)

# --- DIRECTORIES CREATED ---
#   - departments/
#   - backups/
#   - temp/ (removed after use)
#   - reports/

# --- FILES CREATED ---
#   - departments/employee_roster.txt
#   - departments/budget_2026.txt
#   - departments/server_inventory.txt

# --- FILES COPIED TO BACKUP ---
#   - departments/ → backups/departments_backup
#   - departments/employee_roster.txt → backups/

# --- FILES MOVED OR RENAMED ---
#   - budget_2026.txt → budget_2026_REVIEWED.txt

# --- TEMPORARY FILES REMOVED ---
#   - temp/ (entire folder deleted)
